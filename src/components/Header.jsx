...
export default function Header() {
  ...
  useEffect(() => { setTimeout(() => setRays(true), 300); }, []);
    ...
    <header className="site-header">
      ...
      <div className="header-content">
        <div className={`sun-container ${rays ? "rays-active" : ""}`}>
          ...
          <div className="sun-core"><span className="sun-symbol">☀</span></div>
          <div className="sun-halo" />
        </div>
        <p className="header-eyebrow">Les Enfants de la Lumière</p>
        <h1 className="header-title">CULTE DU SOLEIL</h1>
        <p className="header-subtitle"><em>"Le Soleil ne ment jamais. Tout ce qu'il éclaire devient vérité."</em></p>
